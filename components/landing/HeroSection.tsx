...
export default function HeroSection({ seed }: { seed: number }) {
  ...
  const getIconContent = (type: string) => {
    switch (type) {
      case "commit":
        return <GoGitCommit size={32} color="#656565" />;
      case "pr":
        return <GoGitPullRequest size={32} color="#656565" />;
      case "issue":
        return <GoIssueOpened size={32} color="#656565" />;
      default:
        return null;
    }
  };
  ...
  return (
    <div className="flex flex-col justify-center">
      ...
      <div
        className="relative w-full h-80 flex items-center justify-center overflow-hidden rounded-xl mb-8"
